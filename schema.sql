...
(1, 2, 'Lampu Jalan Mati', 'Lampu jalan di depan RT 02 mati sejak dua hari yang lalu.', 'INFRASTRUCTURE', 'Jl. Mawar No. 12', NULL, 'PENDING', NULL);

INSERT INTO `report_histories` (`id`, `report_id`, `user_id`, `previous_status`, `new_status`, `comment`, `image_url`) VALUES
(1, 1, 2, NULL, 'PENDING', 'Laporan dibuat oleh pengguna', NULL);

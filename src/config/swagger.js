      ...
      schemas: {
        ...
        Report: {
          ...
          properties: {
            ...
            image_url: { type: "string", nullable: true, example: "/uploads/report-123.jpg" },
            images: { type: "array", items: { type: "string" }, example: ["/uploads/report-123.jpg", "/uploads/report-456.jpg"] },
            status: { type: "string", enum: ["DIAJUKAN", "MENUNGGU", "DIPROSES", "SELESAI", "DITOLAK"], example: "DIAJUKAN" },
